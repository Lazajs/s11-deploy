  ...
  return (
    <main className="flex flex-col items-center justify-between gap-16 p-10 z-0">
      <div className="max-w-[78.4375rem] mx-auto relative rounded-[1.5625rem] mt-28">
        <Image src='/banner.png' width={1300} height={100} className="w-full" alt="banner" />
        ...
        <div className="absolute top-0 w-full h-full flex items-center justify-between text-white p-16">
          ...
          <Image src='/arrow.svg' width={20} height={20} alt="swipe" />
        </div>
      </div>
        ...
        {items.map((i) => (
          <div key={i.id} className=" ">
            <div className="w-full relative flex justify-center">
              <Image src={i.image} width={150} height={150} className="w-full rounded-[1.5625rem]" alt="event" />
      ...
      <div className="max-w-[78.4375rem] mx-auto relative">
        <Image src='/banner1.png' width={1200} height={20} className="w-full" alt="banner" />
